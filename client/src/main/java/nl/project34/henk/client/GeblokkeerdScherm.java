 ...
 */
public class GeblokkeerdScherm
{
    ...
    public JPanel welkomPanel()
    {
        ...
        JLabel welkomBericht = new JLabel("Uw pas is geblokkeerd");
        ...
        JLabel pasScan = new JLabel("Neem contact op met uw bank!");
